...
#define GPRS_DATA_CONNECT_ATTEMPTS 10
#define GPRS_NETWORK_CONNECT_ATTEMPTS 30
#define GPRS_MODEM_SETUP_ATTEMPTS 3
#define GPRS_MODEM_RESTART_COOLDOWN_MS 60000UL
#define GPRS_INTERNET_CHECK_HOST "example.com"
#define GPRS_INTERNET_CHECK_PORT 80
#define GPRS_INTERNET_CHECK_INTERVAL_MS 30000UL
